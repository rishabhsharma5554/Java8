...
//		employeeList.forEach(System.out::println);
		...
		Employee mostWorkExpEmp = employeeList.stream().sorted(Comparator.comparingInt(Employee::getAge)).findFirst().get();
		System.out.println(mostWorkExpEmp);
		
		System.out.println("\n*********************Query 10 : How many male and female employees are there in the sales and marketing team?");
		Map<String, Long> maleFemaleEmp = employeeList.stream().collect(Collectors.groupingBy(Employee::getGender,Collectors.counting()));
